...
Esse projeto foi gerado usando Angular Cli [Angular CLI](https://github.com/angular/angular-cli) versão 22.0.4.

## Servidor de desenvolvimento

Para começar um servidor local de desenvolvimento, rode:
...
Para testes de ponta a ponta (e2e) rode:

```bash
ng e2e
```

O Angular CLI não inclui, por padrão, um framework de testes de ponta a ponta (end-to-end). Você pode escolher aquele que melhor atenda às suas necessidades.
